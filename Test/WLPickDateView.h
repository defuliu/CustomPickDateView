...
//  Test2222
//
//  Created by 刘德福 on 16/6/12.
//  Copyright © 2016年 刘德福. All rights reserved.
//
...
@class AGLocation;
@protocol WLPickDateViewDelegate <NSObject>
...
@interface WLPickDateView : UIView
...
@property (nonatomic,  assign) id <WLPickDateViewDelegate>delegate;
